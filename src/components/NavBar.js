    ...
    return (
        <header className = 'w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative'>
            ...
            <nav className="flex items-center justify-center flex-wrap">
                ...
                <motion.a href="https://github.com/VeronicaZH00" target={"_blank"}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                    className="w-6 mx-3"
                >
                ...
                <motion.a href="https://www.linkedin.com/in/veronica-chang-a3a990278/" target={"_blank"}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
                    className="w-6 ml-3"
                >
                ...
                : <MoonIcon className={"full-dark"} />}</button>
            </nav>
            </div>
